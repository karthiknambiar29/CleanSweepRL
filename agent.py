...
class BoatNetwork(nn.Module):
    def __init__(self, grid_size, n_actions=8):
        ...
        self.fc_other = nn.Linear(
            3, 32
        )  # tether_length + steps_remaining + active_boat
    ...
    def forward(self, state_dict):
        ...
        # print(state_dict["tether_length"].shape)
        # print(state_dict["steps_remaining"].shape)
        # print(state_dict["active_boat"].shape)
...
class TetheredBoatsAgent:
    ...
    def _to_tensor(self, state_dict):
        ...
        return {
            ...
            .unsqueeze(0)
            .to(self.device),
            "steps_remaining": torch.FloatTensor([state_dict["steps_remaining"]])
            .unsqueeze(0)
            .to(self.device),
    ...
    def train_episode(self, env):
        ...
        while True:
            ...
            full_action = [0, 0]  # Stay action for inactive boat
...
if __name__ == "__main__":
    ...
    wandb.init(project="CleanSweepRL", name="1 trash")  # Initialize wandb
